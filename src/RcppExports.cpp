...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MycoModel_myco_growth", (DL_FUNC) &_MycoModel_myco_growth, 2},
    {"_MycoModel_mycofon_balence", (DL_FUNC) &_MycoModel_mycofon_balence, 27},
