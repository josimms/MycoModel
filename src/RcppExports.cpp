...
// myco_decision
Rcpp::List myco_decision(double C_fungal, double N_fungal, double NC_in_fungal_opt);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MycoModel_mycofon_balence", (DL_FUNC) &_MycoModel_mycofon_balence, 29},
