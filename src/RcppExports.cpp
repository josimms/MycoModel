...
RcppExport SEXP _MycoModel_uptake_N(SEXP NSEXP, SEXP TSEXP, SEXP N_limitSEXP, SEXP kSEXP, SEXP SWCSEXP, SEXP SWC_satSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
